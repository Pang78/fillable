      ...
      {showHowItWorks && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 max-w-lg w-full relative animate-fade-in">
            ...
            <h2 className="text-2xl font-bold mb-2 text-primary">How It Works</h2>
            <p className="mb-4 text-muted-foreground">Fillable lets you generate, manage, and share pre-filled forms in 3 easy steps:</p>
            <ol className="list-decimal pl-6 space-y-2 text-base">
              <li>Paste your FormSG URL</li>
              <li>Add fields manually or import from CSV</li>
              <li>Generate, copy, and share your pre-filled link!</li>
            </ol>
